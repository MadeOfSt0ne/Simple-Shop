...
class PurchaseHistoryServiceTest extends PostgresContainer {
    ...
    @Autowired
    PurchaseHistoryServiceTest(PurchaseHistoryService service,
    ...
    @Test
    void viewHistory() {
        List<SelfPurchaseDto> list = service.viewHistory(1L, 0, 10);
